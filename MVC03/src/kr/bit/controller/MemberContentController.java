...
public class MemberContentController extends HttpServlet {   
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<input type='reset' value='취소하기'  class='btn btn-danger'/>");
		out.println("<a href='/MVC01/memberList.do'><input type='button' value='리스트'  class='btn btn-warning'/></a>");
		out.println("</td>");
		out.println("</tr>");
